...
async function seedLegalPages() {
  try {
    ...
    console.log('✅ Legal pages data seeded successfully!')
    console.log('📄 Tentang Kami data inserted')
    console.log('📋 Syarat & Ketentuan data inserted')
    console.log('🔒 Kebijakan Privasi data inserted')
