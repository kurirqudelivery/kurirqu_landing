      ...
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            {loading ? (
              <>
                <div className="h-12 w-72 mx-auto skeleton mb-6" />
                <div className="h-6 w-full skeleton mb-4" />
                <div className="h-6 w-3/4 mx-auto skeleton" />
              </>
            ) : (
              <>
          ...
          {loading ? (
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div className="bg-white rounded-3xl p-8 shadow-xl max-w-md mx-auto md:mx-0 w-full">
                <div className="h-8 w-48 skeleton mb-4" />
                <div className="h-48 w-48 mx-auto skeleton rounded-xl mb-6" />
                <div className="h-5 w-40 mx-auto skeleton mb-2" />
                <div className="h-4 w-56 mx-auto skeleton" />
              </div>
              <div className="text-center md:text-left">
                <div className="h-8 w-56 skeleton mb-6" />
                <div className="h-14 w-64 skeleton rounded-full mb-8" />
