            ...
            {loading ? (
              <>
                ...
                <div className="mb-6 flex justify-center">
                  <div className="w-[150px] h-[150px] skeleton rounded-full" />
                </div>
                {/* Title skeleton */}
                <div className="h-12 w-96 mx-auto skeleton mb-4" />
                {/* Subtitle skeleton */}
                <div className="h-6 w-72 mx-auto skeleton mb-6" />
                {/* Button skeleton */}
                <div className="mb-8 flex justify-center">
                  <div className="h-14 w-56 skeleton rounded-full" />
                </div>
                {/* Instructions skeleton */}
                <div className="bg-gray-50 rounded-2xl p-4 max-w-4xl mx-auto">
                  <div className="h-6 w-64 mx-auto skeleton mb-3" />
