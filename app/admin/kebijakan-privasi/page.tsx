...
export default function KebijakanPrivasiAdmin() {
  const [data, setData] = useState<KebijakanPrivasiData>({
    headerTitle: "",
    headerSubtitle: "",
    lastUpdated: "",
    sections: []
  ...
  return (
    <div>
      <div className="mb-6">
        <h2 className="text-3xl font-bold text-gray-900">Kelola Kebijakan Privasi</h2>
        <p className="text-gray-600 mt-2">Kelola konten halaman Kebijakan Privasi</p>
      </div>
        ...
        <Card>
          <CardHeader>
            <div className="flex items-center justify-between">
              <CardTitle>Daftar Kebijakan Privasi</CardTitle>
